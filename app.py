...
def create_app():
    ...
    def einrichtung_detail(id):
        ...
        blutentnahmen_quartal = db.get_blutentnahmen_einrichtung(id)
        impfungen_faellig = db.get_faellige_impfungen_einrichtung(id)

        return render_template('einrichtungen/detail.html',
                               einrichtung=einrichtung, 
                               stationen=stationen,
                               stationen_mit_bewohnern=stationen_mit_bewohnern,
                               blutentnahmen_quartal=blutentnahmen_quartal,
    ...
    def patient_detail(id):
        ...
        blutentnahmen = db.get_blutentnahmen(id)
