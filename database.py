...
def get_blutentnahmen_einrichtung(einrichtung_id, stichtag=None):
    ...
    sql = (
        ...
        "AND ("
        "    ((b.status = 'OFFEN' OR b.status = 'GEPLANT') AND (b.naechste_faelligkeit < ? OR b.naechste_faelligkeit IS NULL))"
        "    OR "
        ...
        ")"
        "ORDER BY "
        "  CASE WHEN (b.status = 'OFFEN' OR b.status = 'GEPLANT') AND (b.naechste_faelligkeit < ? OR b.naechste_faelligkeit IS NULL) THEN 0 ELSE 1 END, "
        "  b.naechste_faelligkeit ASC, "
